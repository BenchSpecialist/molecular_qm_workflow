...
## Mamba Installation
All dependencies are managed by [micromamba](https://mamba.readthedocs.io/en/latest/user_guide/micromamba.html),
...
Update `manage_env.sh` script to change the path of the environment,
